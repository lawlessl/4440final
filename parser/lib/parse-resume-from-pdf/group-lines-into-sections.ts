import type { ResumeKey } from '../redux/resume-types.ts';
import {
	hasLetterAndIsAllUpperCase,
	hasOnlyLettersSpacesAmpersands,
	isBold,
} from './extract-resume-from-sections/lib/common-features.ts';
import type { Line, Lines, ResumeSectionToLines } from './types.ts';
...
const SECTION_TITLE_KEYWORDS = [...SECTION_TITLE_PRIMARY_KEYWORDS, ...SECTION_TITLE_SECONDARY_KEYWORDS];
