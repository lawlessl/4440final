import type { FeatureSet, ResumeSectionToLines, TextItem } from '../types.ts';
import { hasComma, hasLetter, hasLetterAndIsAllUpperCase, hasNumber, isBold } from './lib/common-features.ts';
