import type { Resume } from '../../redux/resume-types.ts';
import type { ResumeSectionToLines } from '../types.ts';
import { extractEducation } from './extract-education.ts';
import { extractProfile } from './extract-profile.ts';
import { extractProject } from './extract-project.ts';
import { extractSkills } from './extract-skills.ts';
import { extractWorkExperience } from './extract-work-experience.ts';
